...
//    @NotBlank(message = "订单所选座位不能为空")
    ...
    public SysBill(SysBill bill, SysSession sysSession, SysUser sysUser){
        this.billId = bill.getBillId();
        this.seats = bill.getSeats();
        this.payState = bill.getPayState();
        this.cancelState = bill.getCancelState();
        this.cancelRole = bill.getCancelRole();
        this.createTime = bill.getCreateTime();
        this.deadline = bill.getDeadline();
        this.cancelTime = bill.getCancelTime();
        this.queryByUserName = bill.getQueryByUserName();
        this.remark = bill.getRemark();
        this.delState = bill.getDelState();
