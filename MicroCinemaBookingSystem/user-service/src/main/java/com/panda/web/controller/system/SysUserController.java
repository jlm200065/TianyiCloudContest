...
public class SysUserController extends BaseController {
    ...
    @GetMapping("/seeOtherUser/{id}")
    public ResponseResult seeOtherUserById(@PathVariable Long id) {
        return getResult(sysUserService.findUserById(id));
    }
    ...
    @PutMapping("/sysUser/updateMoney")
    public ResponseResult updateMoney(@Validated @RequestBody SysUser sysUser){
        return getResult(sysUserService.updateMoney(sysUser));
    }
