...
public class SysHallServiceImpl implements SysHallService {
    ...
    @Override
    public List<SysHall> findHallsInGivenCenimaId(Long cinemaId) {
        return sysHallMapper.findHallsInGivenCenimaId(cinemaId);
    }
    ...
    @Override
    public int deleteHallByCinemaId(Long cinemaId) {
        return sysHallMapper.deleteHallByCinemaId(cinemaId);
    }
}
