...
public class SysHallController extends BaseController {
    ...
    @GetMapping("/sysHall/givenCinema/{cinemaId}")
    public ResponseResult findAllHallsInGivenCinema(@PathVariable Long cinemaId) {
        return getResult(sysHallService.findHallsInGivenCenimaId(cinemaId));
